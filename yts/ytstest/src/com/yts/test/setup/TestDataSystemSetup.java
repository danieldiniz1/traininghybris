...
import com.yts.test.constants.YtsTestConstants;
import com.yts.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = YtsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ytstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ytstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/ytstest/import/cstickets.impex");
			...
			importImpexFile(context, "/ytstest/import/csquotes.impex");
		}
	}
}
