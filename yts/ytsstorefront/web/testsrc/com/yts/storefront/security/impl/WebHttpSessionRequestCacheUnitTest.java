...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ytsstorefront/electronics/en",
						"https://electronics.local:9002/ytsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ytsstorefront/electronics/en",
						"https://electronics.local:9002/ytsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ytsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ytsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ytsstorefront/electronics/en",
						"https://electronics.local:9002/ytsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ytsstorefront",
						"https://electronics.local:9002/ytsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ytsstorefront",
						"https://electronics.local:9002/ytsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ytsstorefront/electronics/en",
						"https://electronics.local:9002/ytsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
