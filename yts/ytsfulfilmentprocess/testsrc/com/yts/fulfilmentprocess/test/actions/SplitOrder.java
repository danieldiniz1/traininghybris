 ...
 */
package com.yts.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(YtsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(YtsFulfilmentProcessConstants.PARENT_PROCESS);
